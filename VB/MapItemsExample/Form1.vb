...
#Region "#MapSplineExample"
            Dim spline = New MapSpline() With {.StrokeWidth = 4, .Stroke = Color.Green}
            spline.Points.AddRange(New GeoPoint() {New GeoPoint(-37, 130.63), New GeoPoint(-50, 140.7), New GeoPoint(-32, 150.6)})
            ItemStorage.Items.Add(spline)
#End Region  ' #MapSplineExample
